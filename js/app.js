(() => {
    ...
    function initSliders() {
        if (document.querySelector(".include__slider")) new swiper_core_Swiper(".include__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1.2,
        ...
        if (document.querySelector(".conditions__slider")) new swiper_core_Swiper(".conditions__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
    ...
    if (menuLink) menuLink.forEach((link => {
